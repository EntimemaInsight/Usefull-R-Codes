...
Query <- read_file('//hind.smartitbg.int/FileServer/Data Analyses/Analysis/1.Projects/110_1 WC All Businesses/15 Vintage Analysis/SQL Queries/Vintage_Query_Daily_Spain.sql'
...
saveRDS(Vintage_Data, paste0("//hind.smartitbg.int/FileServer/Data Analyses/Analysis/1.Projects/110_1 WC All Businesses/15 Vintage Analysis/Output Data/Spain Daily/Axi_Spain_Vintage_Data_",Start_Date,"-",End_Date,".rds"))

# Load all rds files, bind and save into one csv
Vintage_RDS_Files = list.files("//hind.smartitbg.int/FileServer/Data Analyses/Analysis/1.Projects/110_1 WC All Businesses/15 Vintage Analysis/Output Data/Spain Daily", pattern = ".rds", full.names = T)
...
fwrite(Vintage_RDS_Files_DF_Wrangled,"//hind.smartitbg.int/FileServer/Data Analyses/Analysis/1.Projects/110_1 WC All Businesses/15 Vintage Analysis/Output Data/Spain Daily/010_Spain_Daily_Vintage_Data.csv")

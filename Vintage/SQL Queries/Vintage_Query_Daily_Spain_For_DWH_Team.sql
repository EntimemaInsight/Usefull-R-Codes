...
SET @Sample_Start_Date_Param = '2023-03-01' ; -- Minimum Date of the Sample 

DECLARE @Sample_End_Date_Param VARCHAR(20);
SET @Sample_End_Date_Param = '2023-03-31'; -- Maximum Date of the Sample 
